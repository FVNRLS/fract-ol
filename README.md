...
<br>`JULIA:          JULIA INSIDE_COLOR OUTSIDE_COLOR OUTLINE_COLOR REAL_CONSTANT IMAGINARY_CONSTANT`
<br>`BURNING_SHIP: BURNING_SHIP INSIDE_COLOR OUTSIDE_COLOR OUTLINE_COLOR`
<br>`PRESETS:        MANDELBROT PRESET PRESET_NAME"`
